...
moradoBajo = np.array([0.391,0.619,0.104])
moradoAlto = np.array([0.160,0.441,0.093])

# Captura cuadro a cuadro
frame = cv2.imread('7chakras.jpg')
...
segMorado = cv2.inRange(yuv,moradoBajo,moradoAlto)  
